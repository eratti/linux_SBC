...
#else
			.min_uV = 400000,
			.max_uV = 1200000, //1P1V8_SW4975000,
#endif
			.valid_ops_mask = REGULATOR_CHANGE_VOLTAGE,
			.valid_modes_mask = 0,
			},
...
static struct pfuze_regulator_init_data mx6q_seco_q7_pfuze100_regulators[] = {
	{.id = PFUZE100_SW1A,	.init_data = &sw1a_init, .default_voltage = -1},
	{.id = PFUZE100_SW1B,	.init_data = &sw1b_init, .default_voltage = -1},
	{.id = PFUZE100_SW1C,	.init_data = &sw1c_init, .default_voltage = -1},
	{.id = PFUZE100_SW2,	.init_data = &sw2_init, .default_voltage = -1},
	{.id = PFUZE100_SW3A,	.init_data = &sw3a_init, .default_voltage = -1},
	{.id = PFUZE100_SW3B,	.init_data = &sw3b_init, .default_voltage = -1},
	{.id = PFUZE100_SW4,	.init_data = &sw4_init, .default_voltage = 35},
	{.id = PFUZE100_SWBST,	.init_data = &swbst_init, .default_voltage = -1},
	{.id = PFUZE100_VSNVS,	.init_data = &vsnvs_init, .default_voltage = -1},
	{.id = PFUZE100_VREFDDR,	.init_data = &vrefddr_init, .default_voltage = -1},
	{.id = PFUZE100_VGEN1,	.init_data = &vgen1_init, .default_voltage = -1},
	{.id = PFUZE100_VGEN2,	.init_data = &vgen2_init, .default_voltage = -1},
	{.id = PFUZE100_VGEN3,	.init_data = &vgen3_init, .default_voltage = -1},
	{.id = PFUZE100_VGEN4,	.init_data = &vgen4_init, .default_voltage = -1},
	{.id = PFUZE100_VGEN5,	.init_data = &vgen5_init, .default_voltage = -1},
	{.id = PFUZE100_VGEN6,	.init_data = &vgen6_init, .default_voltage = -1},
};

static struct pfuze_platform_data pfuze100_plat = {
	.flags = PFUZE_USE_REGULATOR,
	.num_regulators = ARRAY_SIZE(mx6q_seco_q7_pfuze100_regulators),
	.regulators = mx6q_seco_q7_pfuze100_regulators,
...
int __init mx6q_seco_q7_init_pfuze100(u32 int_gpio)
{
	pfuze100_i2c_device.irq = gpio_to_irq(int_gpio); /*update INT gpio */
	int state = i2c_register_board_info(1, &pfuze100_i2c_device, 1);
	return state;
}
