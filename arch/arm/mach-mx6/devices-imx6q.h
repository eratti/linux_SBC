...
extern const struct imx_rtc_bridge_data imx6q_imx_rtc_bridge_data __initconst;
#define imx6q_add_imx_rtc_bridge()        \
        imx_add_rtc_bridge(&imx6q_imx_rtc_bridge_data)

extern const struct imx_seco_pwrb_data imx6_seco_pwrb_data __initconst;
#define imx6q_add_seco_pwrb(pdata) \
        imx_add_seco_pwrb(&imx6_seco_pwrb_data, pdata);
...
#define imx6q_add_mxc_pwm_generic(id, pdata)	   \
	platform_device_register_resndata(NULL, "pwm-generic",\
			id, NULL, 0, pdata, sizeof(*pdata));
