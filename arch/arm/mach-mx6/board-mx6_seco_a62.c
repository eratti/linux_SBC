...
/******************* SPI *******************/
/* NOR */
#define MX6_SECO_A62_CSPI1_CS1      IMX_GPIO_NR(3, 19)
/* RTC */
#define MX6_SECO_A62_CSPI3_CS1      IMX_GPIO_NR(4, 24)
/* Port 2 */
#ifdef CONFIG_A62_PORT_2_CONF_1
#define MX6_SECO_A62_CSPI2_CS1      IMX_GPIO_NR(3, 24)
#endif
/******************* TSC2006 *******************/
 ...
 *                                  UART                               *
 ***********************************************************************/
static const struct imxuart_platform_data mx6_uart4_data __initconst = {
...
static inline void mx6q_seco_a62_init_uart(void) {
	...
	imx6q_add_imx_uart(3, &mx6_uart4_data);    // 4 wire UART4
#endif
...
static int mx6q_seco_q7_spi_1_cs[] = {
    	MX6_SECO_A62_CSPI1_CS1,
};
#ifdef CONFIG_A62_PORT_2_CONF_1
static int mx6q_seco_q7_spi_2_cs[] = {
        MX6_SECO_A62_CSPI2_CS1,
};
#endif
...
static const struct spi_imx_master mx6q_seco_q7_spi_1_data __initconst = {
	.chipselect     = mx6q_seco_q7_spi_1_cs,
	.num_chipselect = ARRAY_SIZE(mx6q_seco_q7_spi_1_cs),
};
#ifdef CONFIG_A62_PORT_2_CONF_1
static const struct spi_imx_master mx6q_seco_q7_spi_2_data __initconst = {
        .chipselect     = mx6q_seco_q7_spi_2_cs,
        .num_chipselect = ARRAY_SIZE(mx6q_seco_q7_spi_2_cs),
};
#endif
...
static const struct flexcan_platform_data imx6_seco_a62_flexcan0_pdata __initconst = {
...
const static struct __init apx_wdog_trigger_data apx_wdt_imx6sdl = {
	...
	.gpio_trg__num          = 25,
        .gpio_en__iomux_ctrl    = 0x20e0130,
        .gpio_en__pad_ctrl      = 0x20e0500,
        .gpio_en__base          = GPIO5_BASE_ADDR,
	.gpio_en__num		= 23,
...
const static struct __init apx_wdog_trigger_data apx_wdt_imx6qd = {
        ...
        .gpio_trg__base         = GPIO3_BASE_ADDR,
        .gpio_trg__num           = 25,
        .gpio_en__iomux_ctrl    = 0x20e00d4,
        .gpio_en__pad_ctrl      = 0x20e03e8,
        .gpio_en__base          = GPIO5_BASE_ADDR,
        .gpio_en__num           = 23,
...
//   GPIO for Ethernet reset
	...
	/* SPI */
	imx6q_add_ecspi(0, &mx6q_seco_q7_spi_1_data);
#ifdef CONFIG_A62_PORT_2_CONF_1
	imx6q_add_ecspi(1, &mx6q_seco_q7_spi_2_data);
#endif
...
#ifdef CONFIG_A62_PORT_3_CONF_1
        imx6q_add_flexcan0(&imx6_seco_a62_flexcan0_pdata);
#endif
